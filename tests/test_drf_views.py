...
class TrackClickAPIViewTest(TestCase):
    ...
    def test_track_click_api_success(self, mock_get_geolocation, mock_get_client_ip):
        ...
        url = reverse('clickify-drf:track_click_api',
    ...
    def test_track_click_api_nonexistent_slug(self, mock_get_geolocation, mock_get_client_ip):
        url = reverse('clickify-drf:track_click_api',
    ...
    def test_track_click_api_rate_limit_exceeded(self, mock_get_geolocation, mock_get_client_it):
        url = reverse('clickify-drf:track_click_api',
                      kwargs={'slug': self.target.slug})
